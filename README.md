# Pretorian Professional Portfolio (Angular)
Professional Portfolio / Portafolio Profesional
Bienvenidos! En este espacio comparto my repositorio para mi portafolio profesional.

**Instructions/Instrucciones:**
1. Clone repo: https://github.com/Pretorian29/my-portfolio.git.
2. $ npm install --force
3. npm install -g @angular/cli
4. npm start   

**Important notes/Notas importantes:**
- To modify the texts: src/assets/i18n/*.json / Para modificar los textos: src/assets/i18n/*.json
- To modify the colors: src/variables.sass / Para modificar los colors: src/variables.scss
- To modify styles: src/styles.scss / Para modificar estilos: src/styles.scss
  
# Developer Portfolios
A list of developer portfolios for your inspiration

# Special thanks to emmabostian for making this list.
To share your portfolio in this list, 0pen a [PR] at emmabostian/developer-portfolios.
